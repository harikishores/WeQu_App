RadarChart = function () {
   ...
   function chart(selection) {
        selection.each(function () {
            ...
            tooltip_node = d3.select('#radarChart')/*.append('div').attr('class', 'tooltip_node')*/;
            ...
            tooltip = tooltip_node.append("div")
               .attr("class", "tooltip")
               .style("opacity", 0);
   ...
   function tooltip_show(d, i, self) {
    // debugger;
         var value = d.original_value ? d.original_value : (d.axis + ': ' +d.value);
